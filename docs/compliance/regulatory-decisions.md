...
| RD-22 | Wat is de **definitieve contractuele en regulatoire rolverdeling** tussen SolidYield en de vergunninghoudende betaalpartners (Mollie voor iDEAL/SEPA, bunq voor IBAN, uitbetalingen en reconciliatie)? | bepaalt de ketenverantwoordelijkheid en de contractuele afspraken | contracten met betaalpartners, technische integratie | **Open** — geregistreerd 2026-08-05 | de partners zijn **betaalpartner, geen productuitgever**: SolidYield blijft contractspartij van de gebruiker en blijft verantwoordelijk voor de eigen vergunningpositie. Dit register doet geen uitspraak over de vergunningen of diensten van Mollie of bunq | | | |
