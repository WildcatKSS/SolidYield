...
| RD-31 | Welke eisen gelden bij **uitbesteding van authenticatie** aan een externe Identity Provider, en welke gegevens mogen daar worden verwerkt? | bepaalt leveranciersselectie, verwerkersovereenkomst en dataresidency | ADR-0004 vervolgactie 5, C-38 | **Open** — geregistreerd 2026-08-06 | **Feiten:** authenticatie wordt uitbesteed aan een externe OIDC-provider; de leverancier is **nog niet gekozen** (Keycloak is uitsluitend MVP-referentie). Identity bewaart geen biometrische gegevens, privésleutels of leesbare wachtwoorden. **Te bepalen door Compliance en Privacy:** eisen aan uitbesteding (RD-10), de verwerkersovereenkomst, en of de gekozen provider binnen de EER blijft (ADR-0006) | | | |
