...
| C-27 | `FR` | Ontworpen | **Keuze wettelijke route** om het besloten bedrijfsmodel uit te voeren | hele dienst | Compliance | **te valideren door specialist** | RD-23 | route laten vaststellen door een gespecialiseerde financieel-regulatoire jurist vóór gebruik met echte gebruikers **Verificatie vindt pas plaats tijdens implementatie en acceptatie**; deze control beschrijft een nog te realiseren maatregel. | | |
...
| C-38 | `CT` | Ontworpen | **Selectie van de Identity Provider** — leverancierskeuze, verwerkersovereenkomst, beschikbaarheid, exit en dataresidency | leveranciers | Security Architect + Tech lead + Privacy | open | [ADR-0004](../architecture/adr/0004-identity-and-access-management.md) vervolgactie 5 | leverancier selecteren en contracteren; DPA afsluiten; dataresidency binnen de EER aantonen ([ADR-0006](../architecture/adr/0006-dataresidency-en-opslaglocatie.md)); beschikbaarheid en herstelscenario beoordelen (T-32). **Keycloak is uitsluitend MVP-referentie, geen gekozen leverancier** **Verificatie vindt pas plaats tijdens implementatie en acceptatie**; deze control beschrijft een nog te realiseren maatregel. | | |
