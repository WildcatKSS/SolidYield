...
| C-39 | `FR` | Nog te ontwerpen | **Juridische positie en houderschap van vrij walletsaldogeld** — rekeningstructuur, safeguarding en vermogensscheiding | wallet, ledger, rekeningstructuur, contractvoorwaarden | Compliance + PO + Tech lead | **te valideren door specialist** | RD-32 · [ADR-0008](../architecture/adr/0008-geld-en-contractstroom.md) | RD-32 laten beantwoorden; daarna de rekening-/safeguardingstructuur juridisch en contractueel vastleggen en het ledger- en rekeningontwerp daarop baseren. **Er is nog geen ontwerpbesluit, geen implementatie en geen juridisch bewijs.** **Echte walletgelden blijven geblokkeerd zolang RD-32 openstaat**, ook wanneer de vereiste vergunning of andere rechtsgeldige toestemming al is verleend. Het ledger- en rekeningontwerp mag de juridische uitkomst **niet vooruitlopen**. Verificatie vindt pas plaats tijdens implementatie en acceptatie | | |
