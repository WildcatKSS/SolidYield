...
| C-17 | `CT` | Regulatoire rolverdeling met betaalpartners (beoogd: Mollie, bunq) | keten | Compliance | **te valideren** | [ADR-0007](../architecture/adr/0007-vergunningplicht-en-rol-in-de-keten.md) · RD-22 | rolverdeling contractueel vastleggen en regulatoir laten beoordelen vóór de eerste echte geldstroom | | |
